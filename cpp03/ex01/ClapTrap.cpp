...
/*   Updated: 2024/12/24 14:12:34 by alaktari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : name("default"), Hit_points(100), Energy_point(50), Attack_demage(20)
{
	std::cout << "ClapTrap default constructor called\n";
}

ClapTrap::ClapTrap(std::string name): name(name), Hit_points(100), Energy_point(50), Attack_demage(20)
{
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (Energy_point > 0 && Hit_points > 0)
	{
		...
		std::cout << "ClapTrap " << name << " can't repair itself, already defeated\n";
}
